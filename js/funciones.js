...
function validar_captcha (){
    let valor_input = document.getElementById("input_validacion").value;
    let valor_captcha=document.getElementById("validacion").innerHTML;
